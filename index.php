        ...
        <div class="col-md-9">
            <section class="list-news doi-song-gen-z">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    ?>
                    <div>
                        <h3><strong><a class="text-dark" href="<?php the_permalink(); ?>"><?php echo chuyenChuHoaThanhThuong($parent_category->name) ?></a></strong></h3>
                    </div>
                    <div>
                        <h6><strong>
        ...
        <div class="col-md-9">
            <section class="list-news luyen-thi">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    ?>
                    <div>
                        <h3><strong><?php echo chuyenChuHoaThanhThuong($parent_category->name); ?></strong></h3>
                    </div>
                    <div>
