							...
							<div id="collapse-3" class="panel-collapse collapse in">
								<div class="panel-body">
									<div class="form-group" ng-class="{'has-error' : (form.scrape_translate_source.$invalid && (form.scrape_translate_source.$dirty || submitted)) || (form.scrape_translate_target.$invalid && (form.scrape_translate_target.$dirty || submitted))}">
										<label class="col-sm-4 control-label"><?php _e('ترجمه خودکار', 'ol-scrapes'); ?> <i class="icon ion-help-circled" data-toggle="popover" data-content="<?php _e('از این فیلد می توانید برای قابلیت ترجمه خودکار انتشار مطالب از وبسایت های خارجی استفاده کنید.', 'ol-scrapes'); ?>"></i></label>
										<div class="col-sm-8">
											<div class="form-group" ng-if="model.scrape_translate_enable">
												<div class="col-sm-12">
													<div class="input-group">
														<div class="input-group-addon"><?php _e('زبان مبدا', 'ol-scrapes'); ?></div>
														<div class="select">
															<select name="scrape_translate_source" class="form-control" ng-model="model.scrape_translate_source" ng-required="true">
																<option value=""><?php _e('لطفا زبان خود را انتخاب کنید', 'ol-scrapes'); ?></option>
												...
												<div class="col-sm-12">
													<div class="input-group">
														<div class="input-group-addon"><?php _e('زبان مقصد', 'ol-scrapes'); ?></div>
														<div class="select">
