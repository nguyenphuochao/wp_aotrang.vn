                    ...
                    <?php while (have_posts()) : the_post(); ?>
                        ...
                        <?php if ($i < 2) { ?>
                            <div class="col-md-6">
                                ...
                                <h6 class="mt-2 title"><strong><a class="text-dark" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></strong></h6>
                                <div class="content text-justify <?php echo str_word_count($title) <= 20 ? 'pt-3' : '' ?>">
                    ...
                    <?php while (have_posts()) : the_post(); ?>
                        <?php if ($i > 1 && $i < 5) : ?>
                            <div class="col-md-4">
                                ...
                                <h6 class="mt-2 title text-justify"><strong><a class="text-dark" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></strong></h6>
                            </div>
                        <?php endif ?>
                        <?php $i++ ?>
                    <?php endwhile; ?>
                    ...
                    <?php while (have_posts()) : the_post(); ?>
                        <?php if ($i > 4 && $i < 30) : ?>
                            ...
                            <div class="col-md-8 mb-2">
                                <h6 class="title"><strong><a class="text-dark" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></strong></h6>
